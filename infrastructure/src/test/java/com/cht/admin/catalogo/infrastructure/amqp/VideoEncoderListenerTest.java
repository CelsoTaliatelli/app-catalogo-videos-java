package com.cht.admin.catalogo.infrastructure.amqp;

import com.cht.admin.catalogo.AmqpTest;
import com.cht.admin.catalogo.application.video.media.update.UpdateMediaStatusCommand;
...
import com.cht.admin.catalogo.domain.video.MediaStatus;
import com.cht.admin.catalogo.infrastructure.configuration.annotations.VideoEncodedQueue;
import com.cht.admin.catalogo.infrastructure.configuration.json.Json;
import com.cht.admin.catalogo.infrastructure.configuration.properties.amqp.QueueProperties;
import com.cht.admin.catalogo.infrastructure.video.models.VideoEncoderCompleted;
import com.cht.admin.catalogo.infrastructure.video.models.VideoEncoderError;
import com.cht.admin.catalogo.infrastructure.video.models.VideoMessage;
import com.cht.admin.catalogo.infrastructure.video.models.VideoMetadata;
...
public class VideoEncoderListenerTest {
    ...
    public void givenCompletedResult_whenCallsListener_shouldCallUseCase() throws InterruptedException {
        ...
        final var expectedOutputBucket = "outputBucket";
