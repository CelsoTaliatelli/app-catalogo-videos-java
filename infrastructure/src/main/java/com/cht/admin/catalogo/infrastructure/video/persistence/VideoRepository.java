package com.cht.admin.catalogo.infrastructure.video.persistence;

import com.cht.admin.catalogo.domain.video.VideoPreview;
...
public interface VideoRepository extends JpaRepository<VideoJpaEntity,String> {
    @Query("""
            select distinct new com.cht.admin.catalogo.domain.video.VideoPreview(
                v.id as id,
                v.title as title,
