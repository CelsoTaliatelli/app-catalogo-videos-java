...
public class AudioVideoMediaTest extends UnitTest {
    ...
    public void givenTwoVideosWithSameChecksumAndLocation_whenCallsEquals_ShouldReturnTrue() {
        ...
        final var img1 =
                AudioVideoMedia.with(expectedId,expectedChecksum, "Random", expectedRawLocation, "", MediaStatus.PENDING);

        final var img2 =
                AudioVideoMedia.with(expectedId,expectedChecksum, "Simple", expectedRawLocation, "", MediaStatus.PENDING);
