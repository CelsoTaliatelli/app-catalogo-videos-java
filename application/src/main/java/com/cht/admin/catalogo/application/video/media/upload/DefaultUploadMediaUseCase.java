...
public class DefaultUploadMediaUseCase extends UploadMediaUseCase{
    ...
    public UploadMediaOutput execute(UploadMediaCommand anCmd) {
        ...
        switch (aResource.type()){
            ...
            case BANNER -> aVideo.updateBanner(mediaResourceGateway.storeImage(anId, aResource));
            case THUMBNAIL -> aVideo.updateThumbnail(mediaResourceGateway.storeImage(anId, aResource));
            case THUMBNAIL_HALF -> aVideo.updateThumbnailHalf(mediaResourceGateway.storeImage(anId, aResource));
        }
